...
<script type="text/javascript">
	...
	function showConfirm() { //취소 버튼 처리
		if (confirm("정말 게시판 화면으로 이동하시겠습니까?")) {
...
<body>
	...
	<div class="container">
		<div class="row">
			...
			<div>
			<button type="button" class="btn btn-success pull-right" id="writeSave">확인</button>
			<button type="button" class="btn btn-default pull-right" id="reset" onclick="showConfirm();">취소</button>
			</div>
		</form>
		</div>
		<br><br>
